...
import argparse
import localfeature_ref.keynet.keyNet.aux.tools as aux
from skimage.transform import pyramid_gaussian
import localfeature_ref.keynet.HSequences_bench.tools.geometry_tools as geo_tools
import localfeature_ref.keynet.HSequences_bench.tools.repeatability_tools as rep_tools
from localfeature_ref.keynet.keyNet.model.keynet_architecture import *
import localfeature_ref.keynet.keyNet.aux.desc_aux_function as loss_desc
from localfeature_ref.keynet.keyNet.model.hardnet_pytorch import *
from localfeature_ref.keynet.keyNet.datasets.dataset_utils import read_bw_image
import torch
...
def extract_keypoints(image):
    ...
    parser.add_argument('--checkpoint-det-dir', type=str, default='./localfeature_ref/keynet/keyNet/pretrained_nets/KeyNet_default',
                        help='The path to the checkpoint file to load the detector weights.')

    parser.add_argument('--pytorch-hardnet-dir', type=str, default='./localfeature_ref/keynet/keyNet/pretrained_nets/HardNet++.pth',
    ...
    def extract_features(image):
        ...
        for (j, resized) in enumerate(pyramid):
            ...
            im = resized.reshape(1, resized.shape[1], resized.shape[2], 1)
    ...
    with tf.Graph().as_default():
        ...
        #     init_assign_op_det, init_feed_dict_det = tf.contrib.framework.assign_from_checkpoint_fn(
