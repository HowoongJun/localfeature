...
from localfeature_ref.lift.python.Utils.kp_tools import (IDX_ANGLE, IDX_OCTAVE, IDX_RESPONSE, IDX_SIZE,
...
if platform.system() == "Darwin":
    libSIFT = cdll.LoadLibrary("./localfeature_ref/lift/c-code/libSIFT.dylib")
else:
    libSIFT = cdll.LoadLibrary('./localfeature_ref/lift/c-code/libSIFT.so')
