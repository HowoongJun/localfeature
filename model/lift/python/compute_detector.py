...
from localfeature_ref.lift.python.Utils.custom_types import paramGroup, paramStruct, pathConfig
from localfeature_ref.lift.python.Utils.dump_tools import loadh5
from localfeature_ref.lift.python.Utils.filter_tools import apply_learned_filter_2_image_no_theano
from localfeature_ref.lift.python.Utils.kp_tools import XYZS2kpList, get_XYZS_from_res_list, saveKpListToTxt
from localfeature_ref.lift.python.Utils.sift_tools import recomputeOrientation
from localfeature_ref.lift.python.Utils.solvers import TestImage

floatX = 'float32'

# ------------------------------------------
# Main routine
def compute_detector(image_gray):

    total_time = 0

    config_file = "./localfeature_ref/lift/models/configs/picc-finetune-nopair.config"
